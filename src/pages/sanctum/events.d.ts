...
export interface EventSnapshot { sessions: Map<string, boolean>; selectedId: string | null; totalCost: number; contextId: string | null }
export const EVENT_DURATIONS: Readonly<Record<SanctumEventType, number>>;
export function snapshotSessions(sessions: Array<{ session_id: string; is_ghost?: boolean }>, selectedId: string | null, totalCost: number, contextId?: string | null): EventSnapshot;
